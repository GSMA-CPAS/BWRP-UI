...
export default {
  ...
  methods: {
    ...
    calculateHomeRevenues() {
      ...
      this.secondPercentageDiscrepancy = parseFloat(this.homeCharges) !== parseFloat(0.00) ? ((this.partnerRevenues - this.homeCharges)*100/this.partnerRevenues).toFixed(2) : '0.00';
