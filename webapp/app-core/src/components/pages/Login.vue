                ...
                <v-col cols="12" sm="8" md="4">
                    <v-card class="elevation-6">
                        ...
                        <v-form ref="form" v-model="valid" lazy-validation @submit.prevent="login">
                            <v-card-text>
                                    <v-text-field v-model="username" label="Username" color="secondary" :rules="[rules.required]" autofocus></v-text-field>
                                    <v-text-field type="password" v-model="password" label="Password" color="secondary" :rules="[rules.required]"></v-text-field>
                            </v-card-text>
