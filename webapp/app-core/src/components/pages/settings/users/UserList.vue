<template>
    <layout :loading="loading">
        <v-container fluid>
            <v-row>
                <v-col cols="6"><v-breadcrumbs :items="breadcrumbItems" large></v-breadcrumbs></v-col>
                <v-col cols="6" class="text-right"><v-btn tile color="primary" to="/settings/users/create">Create User</v-btn></v-col>
            </v-row>
            <v-spacer></v-spacer>
            <v-row>
                <v-col cols="12">
