      ...
      <v-row>
        <v-col cols="12" lg="6">
          <v-card>
            ...
            <v-card-text>
              To enable two-factor authentication you will need to have an authenticator app (such as Google
              Authenticator or Authy) installed on your mobile phone. Scan this QR code or enter the plain text key into
              the authenticator app and enter the code in the field below to activate two-factor authentication.
            </v-card-text>
            <v-card-text>
