(function(global, $, thisPage) {
    ...
    const thisModuleEventHandlers = function() {
        ...
        _TABLE = $('#boardDataTables').DataTable({
            ...
            dom: 'lrtip',
            ajax: {
                url: _CTX + 'board/notice/findNotice',
        ...
        $('#writeBoard').on('click', function(e) {
            e.preventDefault();
            global.location.href = _CTX + 'board/notice/writeNotice';
        });
        ...
        $(document).on('click', '.detail', function(e) {
            ...
            let url = _CTX + 'board/notice/noticeDetail?bbsId=' + bbsId + '&bbsAuthor=' + bbsAuthor;
